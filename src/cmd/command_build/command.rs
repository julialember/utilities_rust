...
impl fmt::Display for BuildError<'_> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Self::PipeError(e) => 
                writeln!(f, "shu: error with build pipe command: {}", e),
            Self::UnexpectedArg(s) => 
                writeln!(f, "shu: unexpected arg: {}", s),
            Self::UnopenedFile(n, s) => 
                writeln!(f, "shu: can't open the file ({}): {}", n.display(), s),
            Self::NoArgument(s) => 
                writeln!(f, "shu: no argument after: {}", s),
        }
    }
}
...
impl<E: fmt::Display> fmt::Display for CommandError<'_, E>{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Self::WriteError(s) => 
                write!(f, "shu: error with write into file: {}", s),
            Self::Help => 
                write!(f, "shu: Just helping"),
            Self::Other(name, e) => 
                write!(f, "shu: {}: {}", name, e),
            Self::BuildError(e) => 
                write!(f, "shu: build Error: {}", e),
        }
    }
}    
